...
LEGO_CATEGORIES = [
    ...
    "Animal, Land",
    "Animal, Land, Decorated",
    "Animal, Water",
    "Animal, Water, Decorated",
    "Antenna",
    "Arch",
    "Arm/Leg",
    "Bar",
    ...
    "Duplo, Boat",
    "Duplo, Brick",
    "Duplo, Bricks Special",
    "Duplo, Car",
    "Duplo, Figure",
    "Duplo, Figure Accessory",
    "Duplo, Figure Hair",
    "Duplo, Figure Torso",
    "Duplo, Fence",
    "Duplo, Furniture",
    ...
    "Glass",
    "Glass, Decorated",
    "Glass, Glass for Window",
    "Grab Jaw",
    "Hinge",
    "HO 1:87 Model",
    "HO 1:87 Model, Decorated",
    "HO 1:87 Model, Train",
    "Horse",
    "Horse, Decorated",
    "House, Furnishings",
    ...
    "Mechanical Arm",
    "Mechanical Device",
    "Mechanical Device, Decorated",
    "Minifigure, Hair",
    "Minifigure, Head",
    "Minifigure, Headgear",
    "Minifigure, Helmet",
    "Minifigure, Mechanical Accessory",
    "Minifigure, Neckwear",
    "Minifigure, Shield",
    "Minifigure, Torso",
    "Minifigure, Tool",
    "Minifigure, Undecorated",
    "Minifigure, Utensil",
    "Minifigure, Weapon",
    "Minifigure, Weapon Accessory",
    "Minifigs, Decorated",
    "Minifigs, Undecorated",
    "Motorcycle",
    "Musical",
    "Net",
    "Panel",
    ...
    "Technic, Axle",
    "Technic, Beam",
    "Technic, Beam, Decorated",
    "Technic, Brick",
    "Technic, Brick, Decorated",
    "Technic, Gear",
    "Technic, Gear Rack",
    "Technic, Link",
    "Technic, Link, Decorated",
    "Technic, Liftarm",
